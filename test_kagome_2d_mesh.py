...
from functions import kagome_horizontal, triangle_horizontal, kagome_sine_horizontal
...
for mesh_size in [2, 1.5, 1, 0.7, 0.5, 0.3, 0.2, 0.15, 0.1]:
    lattice_tensile_test(mapdl, lattice_type='kagome_h', mesh_size=mesh_size, n_cell=3, relative_density=0.45, three_dim=False, filename=f'n{3}_r{45}')
mapdl.exit()